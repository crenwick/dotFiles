  ...
  spec = {
      ...
      config = function()
        ...
        vim.api.nvim_create_autocmd('LspAttach', {
          ...
          callback = function(event)
            ...
            -- Execute a code action, cursor needs to be on top of an error
        ...
        local ensure_installed = vim.tbl_keys(servers or {})
        vim.list_extend(ensure_installed, {
          'lua-language-server', -- Changed from 'lua_ls'
          'stylua',
        })
    ...
    { -- Autoformat
      ...
      keys = {
        {
          '<leader>f',
          function() require('conform').format { async = true, lsp_fallback = 'fallback' } end,
          mode = '',
          desc = '[F]ormat buffer',
        },
      },
    ...
    { -- Highlight, edit, and navigate code
      ...
      -- master branch is the 'old' one.
      -- Supported up to Neovim 0.12
      branch = 'master',
      lazy = false,
      build = ':TSUpdate',

      -- nvim-TS opts are not passed in at the standard place
